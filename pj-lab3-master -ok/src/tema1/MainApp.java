...
public class MainApp
{
    public static void main(String[] args)
    {
        try
        {
            ...
            if (parabole.size() >= 2)
            {
                System.out.println("lungimea segmentului dintre varful primei si ultimei parabole = " + Parabola.getDistanta(parabole.get(0), parabole.get(parabole.size() - 1)));
                Double[] mijloc = parabole.get(0).getMijloc(parabole.get(parabole.size() - 1));
